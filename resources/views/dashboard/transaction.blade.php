                ...
                <div>
                    <div class="form-control">
                        ...
                        <div class="flex-row">
                            <select name="type" class="select select-bordered w-full" id="typeInput">
                                <option disabled="disabled" selected="selected">Choose Transaction Type will Used</option>
                    ...
                    <div class="form-control">
                        ...
                        <input type="date" name="date" placeholder=""
                            class="input input-secondary input-bordered w-full bg-neutral-content text-black" id="dateInput">
                    </div>
                    <div class="form-control">
                        <label class="label">
