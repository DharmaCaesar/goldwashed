...
<div class="modal" id="takeInvoice">
  <div class="modal-box min-w-full">
        ...
        <table class="table w-full table-compact text-center" id="inpaktab">
            ...
            <tfoot>
                <tr>
                    ...
                    <th></th>
                    <th>Subtotal</th>
                    <th><span class="normal-case">Rp.</span> <span id="total"></span></th>
                ...
                <tr>
                    ...
                    <th><span class="normal-case">Rp.</span> <span id="sumtal"></span></th>
                    <th></th>
                </tr>
            </tfoot>
        </table>
    ...
    <div class="modal-action">
        <button type="button" class="btn btn-outline my-10 mx-2" onclick="document.getElementById('takeInvoice').classList.remove('modal-open')">Cancel</button>
    </div>
  </div>
</div>
